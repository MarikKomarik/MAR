...
<html lang="en">
  <head>
    ...
    <title>“Завораживающий Невский”</title>
    ...
    <section class="inner-first-screen">
        ...
        <div class="inner-first-screen_wrapper">
            <ul class="inner-first-screen_breadcrumbs">
                ...
                <li class="inner-first-screen_breadcrumbs_item">“По Петроградскому району”</li>
                <li class="inner-first-screen_breadcrumbs_item">“Завораживающий Невский”</li>
            </ul>
            <h1 class="inner-first-screen_heading">“Завораживающий Невский”</h1>
            <div>
    </section> 
    ...
    <div class="container_footer">
      <footer class="main-footer">
        ...
        <ul class="main-menu">
          ...
          <li class="main-menu__item">
            <a href="./profil.html" class="main-menu__link">ПРОФИЛЬ</a>
          </li>
        </ul>
    </footer>
  </div>
