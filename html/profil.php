    ...
    <section class="inner-first-screen">
        ...
        <div class="inner-first-screen_wrapper">
            <ul class="inner-first-screen_breadcrumbs">
                ...
                <li class="inner-first-screen_breadcrumbs_item">Профиль</li>
            </ul>
            <h1 class="inner-first-screen_heading">ПРОФИЛЬ</h1>
        </div>
  ...
  <section class="profil">
      ...
      <div class="row"> 
          ...
          <div class="col-6">
              ...
              <ul class="main-nav">
                <li class="profil-red">
                    <button class="profil-red_button">
                      <img src="./../img/src/buttons/red.svg" alt="" class="profil-red_image">
                    </button>
                </li>
          ...
          <div class="col-1">
              <ul class="types_marshruts-slides">
                  <li class="types_marshruts-slide">
                    <span class="types_marshruts-head-numbers">10 </span>сохранённых маршрутов </li>
                  <li class="types_marshruts-slide">
                    <span class="types_marshruts-head-numbers">0 </span>созданных маршрутов</li>
              </ul>
          </div>
      ...
      <div class="col-4">
          ...
          <div class="swiper typesSwiper">
              <img src="./../img/src/categories/category 02.jpg" alt="фото">  
          </div>
    ...
    <div class="main-footer_last-line">
          <p class="main-footer_pharagraph">
            Машруты по Санкт-Петербургу 2024
          </p>
