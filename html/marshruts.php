...
<body>
  ...
  <section class="inner-first-screen">
    ...
    <div class="inner-first-screen_wrapper">
      ...
      <p class="inner-first-screen_lead">Выбирай любую категорию маршрутов, сохраняй себе, чтобы не забыть пройти именно его и наслаждайся видами и историей мимо проходящих мест!
    </div>
  </section>
